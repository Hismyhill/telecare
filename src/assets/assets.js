...
import dropdown_icon from "./icon/dropdown_icon.svg";
import menu_icon from "./icon/menu_icon.svg";
import cross_icon from "./img/cross_icon.png";
import chats_icon from "./icon/chats_icon.svg";
import verified_icon from "./icon/verified_icon.svg";
...
import Dermatologist from "./icon/Dermatologist.svg";
import Gastroenterologist from "./icon/Gastroenterologist.svg";
import General_physician from "./icon/General_physician.svg";
import Gynecologist from "./icon/Gynecologist.svg";
import Neurologist from "./icon/Neurologist.svg";
import Pediatricians from "./icon/Pediatricians.svg";
