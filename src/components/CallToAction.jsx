    ...
    <div className="flex bg-primary rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10">
      <div className="flex-1 py-8 sm:py-16 lg:py-24 lg:pl-5">
        <div className="text-xl sm:text-2xl lg:text-3xl font-semibold text-white">
          ...
          <p className="mt-4 ">With 100+ Trusted and Verified Doctors</p>
        </div>
        <button
          onClick={() => {
            navigate("/login");
      ...
      <div className="hidden md:block md:w-1/2 lg:w--[37rem] relative">
        <img
          className="w-full absolute bottom-0 max-w-md"
